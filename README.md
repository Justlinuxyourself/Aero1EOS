...
When you use the `echo` command, it simply prints out the text you want to see on the screen.

It picks a random verse from the Quran and shows it to you.

This feature selects a random verse from the Bible and displays it for you.

| `tdadd` | This is used to add a new to-do item to the list in memory. |

| To-Do List | Displays tasks stored in memory. |
